...
{
    // Kasper  Fly
    public class ResourceTileGridBar
    {
        public GameObject mainGameObject;
        Scene myScene;
        PlaceTileWithMouse placeTile;
        TextureSheet2D nothingPixel = new TextureSheet2D(SpriteContainer.Instance.Pixel, new Vector2(0, 0), new Vector2(1, 1));
        public ResourceTileGridBar(Scene myScene, GameObject go, PlaceTileWithMouse placeTile)
        {
        ...
        public void MadeUI()
        {
            ...
            int postion = -275;
            MakeSlot(new Vector2(postion, -100), nothingPixel, "1", EResourcesType.Nothing);
            postion += 70;
            MakeSlot(new Vector2(postion, -100), SpriteContainer.Instance.TileSprite.Gold, "2", EResourcesType.Gold);
            postion += 70;
            MakeSlot(new Vector2(postion, -100), SpriteContainer.Instance.TileSprite.Stone, "3", EResourcesType.Stone);
            postion += 70;
            MakeSlot(new Vector2(postion, -100), SpriteContainer.Instance.TileSprite.Wood, "4", EResourcesType.Wood);
            postion += 70;
            MakeSlot(new Vector2(postion, -100), SpriteContainer.Instance.TileSprite.Wheatfield, "5", EResourcesType.Food);
